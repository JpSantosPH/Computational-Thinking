...
random_vect = [rand() for i in 1:10] # replace `missing` with your code!
...
head_red_M = get_reds(philip_head)

# ╔═╡ a9ed0b62-3276-4252-9bf1-a97342729657
value_as_color.(head_red_M)
...
# ╔═╡ d1ffdc57-998c-43f2-af23-07e1c2fdb7aa
...
function get_greens(image::AbstractMatrix)
	new_image = get_green.(image)
	return new_image
end

# ╔═╡ 1ee54cdf-fe33-418d-af9d-c1d7afba9948
function get_blue(pixel::AbstractRGB)
	b = pixel.b
	return b
end

# ╔═╡ b50fd978-0afc-4152-9ad8-2c01ce653498
function get_blues(image::AbstractMatrix)
	new_image = get_blue.(image)
	return new_image
end
...
function invert(color::AbstractRGB)
	...
	inverted_color = RGB(inv_red, inv_green, inv_blue)
...
function quantize(color::AbstractRGB)
	new_red = quantize(color.r)
	new_green = quantize(color.g)
	new_blue = quantize(color.b)
	
	new_color = RGB(new_red, new_green, new_blue)
	return new_color
end
...
function noisify(x::Number, s)
	abs
	noise = rand(-s:0.0001:s)
	new_x = clamp(x + noise, 0, 1)
	return new_x
end

# ╔═╡ c9cbcaf4-1ddc-4cc3-b645-572157860768
0.01/100
...
function noisify(color::AbstractRGB, s)
	new_red = noisify(color.r, s)
	new_green = noisify(color.g, s)
	new_blue = noisify(color.b, s)
...
# ╔═╡ 40cb768e-ab0c-4289-9c02-d127af5a5f98
[noisify(color_red, j) for i ∈ 1:10, j in 0 : 0.05 : 1]
...
The image is unrecognisable with intensity greater than 2.20 because it significantly lowers the odds of getting na noise value close to 0.
"""
...
function custom_filter(pixel::AbstractRGB)
	new_pixel = RGB(pixel.r, pixel.r, pixel.r)
	return new_pixel
end
...
# ╔═╡ a8173b15-74ca-47d1-87f7-616eaa8c6122
function custom_filter_2(pixel::AbstractRGB)
	new_pixel = RGB(pixel.g, pixel.g, pixel.g)
	return new_pixel
end

# ╔═╡ c3e0497a-c34c-4695-a6e0-699cdc63598b
function custom_filter_2(image::AbstractMatrix)
	
	return custom_filter_2.(image)
end

# ╔═╡ c8f83c93-c74f-4536-88db-1d4b01b7fd5c
function custom_filter_3(pixel::AbstractRGB)
	new_pixel = RGB(pixel.b, pixel.b, pixel.b)
	return new_pixel
end

# ╔═╡ 20d73250-9430-4578-9fa3-3bbb05e2eb00
function custom_filter_3(image::AbstractMatrix)
	
	return custom_filter_3.(image)
end
...
# ╔═╡ 8ae27657-adf3-4bb0-800a-9e3f9a6c56a7
custom_filter_2(cam_image)

# ╔═╡ 359f8f6e-6457-4ee7-8c90-211e9b4430a7
custom_filter_3(cam_image)
