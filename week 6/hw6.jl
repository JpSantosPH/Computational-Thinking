...
# ╔═╡ 06cdc835-5a9e-46b7-9e65-ff38deb1d18e
function sin_cos_plot()
    T = -1.0:0.01:1.0
...
# ╔═╡ 03c395cc-560f-4405-9691-cba84626dffe
sin_cos_plot()
...
@bind pp Slider(0:0.01:1)

# ╔═╡ 9a92eba4-ad68-4c53-a242-734718aeb3f1
@bind NN Slider(1:100000)

# ╔═╡ 48751015-c374-4a77-8a00-bca81bbc8305
large_experiment_2 = experiment(pp, NN)
...
function ten_thousand_experiment(p; N=10000)
		result = Int.([])
...
function meanp_vs_p()
	collect_p = collect(0.01:0.01:1)
	result = Int.([])
	for i in collect_p
		push!(result, ten_thousand_experiment(i))
	end
	return collect_p, result
end

# ╔═╡ 501bcc30-f96f-42e4-a5aa-09a4138b5b72
observations_result = meanp_vs_p()

# ╔═╡ b763b6e8-8221-4b08-9a8e-8d5e63cbd144
let
		xs, ps = observations_result
