...
From rank 1/2 of the number of entries n or 1/2 n.

Because when you group all the horizontal and vertical vectors and arrange them so that they stack on top of each other, they form a two n by 1/2 n matrix which you can then combine to get an n by n matrix.
"""
